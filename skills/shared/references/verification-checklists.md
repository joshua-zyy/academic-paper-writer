...
本文件为 Gate C（Verification）提供按 section 类型分类的验证检查清单。在 Step 10 Self-Review & Verification 中，根据当前 section 类型加载对应清单逐项检查。
...
在 Step 10 Verification 中，根据 `section` 字段选择对应清单：
