...
## Red Lines
1. **只修改论文草稿文本——禁止修改项目代码或数据文件**：润色 agent 只修改传入的论文草稿文本，**绝对不得修改项目中的源代码、配置文件、数据文件或实验脚本**。
2. 禁止将编造内容包装成学术表述
3. 禁止在无数据支撑时使用"显著的""重要的"等空洞强化词
4. 禁止把未核验的 user_claim 改写成确定性的强结论
5. 禁止在 Method 中保留元评论、代码讲解或审稿人对话口吻
6. 禁止用更华丽的措辞掩盖 evidence gap
